...
# import asyncio
# from utils import schedule_progress_bar_update, create_now_playing_embed
...
#         await handle_pause_button(interaction, self.entry)

#     async def resume_button_callback(self, interaction: Interaction):
#         await handle_resume_button(interaction, self.entry)
